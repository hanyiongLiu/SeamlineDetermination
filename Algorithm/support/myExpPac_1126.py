    ...
    def water(self, seed, end):
        ...
        while True:
            ...
            while path_list:
                ...
                processMap[p[1], p[0]] = 0
                for next_p in [
                    x for x in neighbors if processMap[x[1], x[0]] != 0]:
                    if self.img[next_p[1]][next_p[0]] < threshold:
                        path[next_p] = p
                        path_list.append(next_p)
                    processMap[next_p[1], next_p[0]] = 0
